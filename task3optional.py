...
if __name__ == '__main__':
    ...
    print(f'Accuracy on test set: {round(accuracy*100,3)}%')
    print(f'Precision on test set: {round(precision*100,3)}%')
    print(f'Recall on test set: {round(recall*100,3)}%')
    print(f'F1 on test set: {round(f1*100,3)}%')
